...
REG ADD HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\Run /v EFIBootSelector /d "C:\Windows\System32\cmd.exe /k start C:\efibootselector\eficlient.exe" /y 
